...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_ANNEE = 258,               /* TOK_ANNEE  */
    TOK_NIVEAU = 259,              /* TOK_NIVEAU  */
    TOK_ETUDIANT = 260,            /* TOK_ETUDIANT  */
    TOK_MATRICULE = 261,           /* TOK_MATRICULE  */
    TOK_NOM = 262,                 /* TOK_NOM  */
    TOK_PRENOM = 263,              /* TOK_PRENOM  */
    TOK_SEMESTRE = 264,            /* TOK_SEMESTRE  */
    TOK_MODULE = 265,              /* TOK_MODULE  */
    TOK_COEF = 266,                /* TOK_COEF  */
    TOK_NOTE = 267,                /* TOK_NOTE  */
    TOK_ID_NIVEAU = 268,           /* TOK_ID_NIVEAU  */
    TOK_ID_SEM = 269,              /* TOK_ID_SEM  */
    TOK_STRING = 270,              /* TOK_STRING  */
    TOK_ENTIER = 271,              /* TOK_ENTIER  */
    TOK_REEL = 272                 /* TOK_REEL  */
  };
